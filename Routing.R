...
#This section covers the second sub-page, which contains charts that display the design and nature of fair work score by work characteristics. 
  ...
  wellPanel(fluidRow(
    column(
      width = 6,
      HTML("
      <li>This page covers graduates' design and nature of work score, split by three work characteristics. Whether they required their qualification for their work, the standard occupational code of their job role, and their job contract length.</li>
      <p>  </p>
      <li>From this, we can see that when graduates are employed in job roles that require their degree, they have a higher design and nature of work score. As agreement increases, so does their score.</li>
      <p>  </p>
     <li>Graduates who are employed in SOC group 2 hold the highest design and nature of work score, with those in SOC group 1 coming in second. This may be linked to the qualification requirement mentioned above. Interestingly, graduates employed in SOC group 7 Caring, leisure and other caring activities, have the third highest score. This is likely due to the highly vocational nature of their work.</li>
      <p>  </p>
     <li>Graduates who are in permanent/open-ended contracts also have the highest design and nature of work score. This likely represents the benefit that job security offers to graduates, which is then reflected in their score. In support of this, graduates who are employed on zero-hour contracts have the worst design and nature of work score, which indicates that greater job insecurity had a negative impact on their design and nature of work score.</li>")
    , style = "font-size: 16px;"),
    br(),
